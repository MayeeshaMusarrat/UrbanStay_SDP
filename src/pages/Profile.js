  ...
  return (
    <>
      <div className={styles.profile}>
        ...
        <div className={styles.profileCardParent}>
          <div className={styles.profileCard}>
            ...
            <div className={styles.userlanguage}>
              <img
                className={styles.iconoirlanguage}
                alt=""
                src="/iconoirlanguage.svg"
              />
              <div className={styles.speaksEnglishBanglaContainer}>
                <p className={styles.speaksEnglishBangla}>
                  Speaks English, Bangla, Hindi,
                </p>
                <p className={styles.speaksEnglishBangla}>Espanol, Mandarin</p>
              </div>
            </div>
          </div>
        ...
        <div className={styles.iAmAStudentWhoLivesInBaParent}>
          <div className={styles.iAmA}>
            I am a Student who lives in Bangladsh. I run the most successful
            host in the town, though I built my mudhouse two years ago, and my
            treehouse less than a year ago. Virtually all my guests have written
            a review, and virtually all of them have written me five star
            reviews. I'm a very involved host who attends to every need of my
            guests, from the time they book my cottages to the time they check
            out. I, along offer the best service in the town.
          </div>
          ...
          <div className={styles.earningGraphWrapper}>
            ...
            series={[
              {
                data: [100,200,350,50,90,567,340,1000,1400,120,100,310],
              },
            ]}
            width={900}
            height={300}
