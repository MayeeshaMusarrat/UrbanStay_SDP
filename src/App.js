...
import ShowPastReservations from './pages/ShowPastReservations';
...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/show-reservations/:PID" element={<ShowReservations />} />
      ...
      <Route path="/show-past-reservations/:PID" element={<ShowPastReservations />} />
